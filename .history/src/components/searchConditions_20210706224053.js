...
function SearchConditions() {
    ...
    function addQueryBox() {
        ...
        changeSearchConditionContainerHeight(-1);
    };
    ...
    function changeSearchConditionContainerHeight(modifier) {
        console.log(queryBoxes.length);
    }

    changeSearchConditionContainerHeight();
