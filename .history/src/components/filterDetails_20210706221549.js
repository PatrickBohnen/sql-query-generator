...
class StringConditions extends React.Component {
    render() {
        ...
        if (this.filterField === 'user_email') {
            optionPlaceholder = 'example@email.com';
        } else if (this.filterField === 'user_first_name') {
            optionPlaceholder = 'First Name';
        } else if (this.filterField === 'user_last_name') {
            optionPlaceholder = 'Last Name';
        } else if (this.filterField === 'domain') {
            optionPlaceholder = 'Domain';
        } else if (this.filterField === 'path') {
