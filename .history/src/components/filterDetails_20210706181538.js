            ...
            <div className={isBetween ? 'is-between' : ''}>
                ...
                {isBetween ? (
                    <div>
                        ...
                        <input className='int-cieling' type='number' name='intCeiling' placeholder='0'></input>
                    </div>        
                ) : (
                    <input className='int-single' type='number' name='intSingle' placeholder='0'></input>
                )}
            </div>
        );
    }
...
const StringConditions = (props) => {
    ...
    return (
        <div>
            ...
            <input className='string-single' type='text' name='stringSingle' placeholder={optionPlaceholder ? optionPlaceholder : 'Search sessions.'}></input>
        </div>
    );
};
